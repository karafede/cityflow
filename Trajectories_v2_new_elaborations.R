...
DF <- read.csv('D:/Federico/CityFLows/output_files/MILANO_1_BICI_from_2021-10-10__13h40min_to_2021-10-10__13h58min.txt')[-1]
...
# write.csv(all_ID_speed, file = paste0("D:/Federico/CityFLows/output_files/all_ID_speeds_duca_aosta_angles_b.csv"), row.names=FALSE)
# write.csv(all_ID_speed, file = paste0("D:/Federico/CityFLows/output_files/all_ID_speeds_lato_taxi_angles_b.csv"), row.names=FALSE)
write.csv(all_ID_speed, file = paste0("D:/Federico/CityFLows/output_files/all_ID_speeds_lato_biciclette_angles_new_elaborations.csv"), row.names=FALSE)
